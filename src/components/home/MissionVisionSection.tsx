      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 md:gap-16">
          ...
          <motion.div 
            ...
            className="relative p-10 md:p-14 rounded-3xl bg-white dark:bg-[#251525] shadow-2xl overflow-hidden group"
          >
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-vipro-magenta flex items-center justify-center mb-8 shadow-lg shadow-vipro-magenta/30 text-white">
                <Target className="w-8 h-8" />
              </div>
              <h3 className="text-3xl font-serif font-bold text-vipro-purple dark:text-vipro-beige mb-6">{content?.missionTitle || "Our Mission"}</h3>
              <ul className="space-y-4 text-gray-600 dark:text-gray-300 text-lg">
                {(content?.missionPoints || [
                  ...
                  <li key={idx} className="flex items-start">
                    <span className="text-vipro-magenta mr-3">✦</span>
                    {point}
                  </li>
                ))}
              </ul>
          ...
          <motion.div 
            ...
            className="relative p-10 md:p-14 rounded-3xl bg-vipro-purple dark:bg-[#140814] shadow-2xl overflow-hidden group text-white"
          >
            {/* Morphing Background Shape */}
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-vipro-gold flex items-center justify-center mb-8 shadow-lg shadow-vipro-gold/30 text-vipro-purple">
                <Eye className="w-8 h-8" />
              </div>
              <h3 className="text-3xl font-serif font-bold text-vipro-beige mb-6">{content?.visionTitle || "Our Vision"}</h3>
              <p className="text-xl text-gray-200 leading-relaxed italic font-serif">
